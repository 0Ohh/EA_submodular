...
if __name__ == "__main__":
    ...
    sensorResult = GetSensorResult('./Beijing_temperature.txt')
    print(np.shape(sensorResult))
    [attributesNum,nodeNum]=np.shape(sensorResult)
    weightMatrix=GetWeight('./Beijing_temperature_route.txt','./Beijing_temperature_route_weight_norm.txt',nodeNum)
    nodeCost=GetNodeCost('./Beijing_temperature_rand_cost.txt')
